                ...
                <div class="card">
                    <div class="card-body mt-3 mb-3 ml-2 mr-2">
                        ...
                        <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="customerlist" class="display dataTable table-bordered"
                                        style="width:100%;">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                            ...
                                            <tr v-for="(customer, index) in paginatedCustomers" :key="customer.id">
                                                ...
                                                <td>
                                                    <div style="display: flex; justify-content: center;">
                                                        <router-link :to="`/admin/customer/${customer.id}/points`"
                                                        ...
                                                        <a class="btn btn-danger btn-sm text-white"
                                                            ...
                                                            style="margin-right: 5px;"><i class="fa fa-redo"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
