<template>
    ...
    <footer :class="['mobile-footer', showModal || showSearch ? 'no-radius' : '']"
        class="d-flex d-md-none fixed-bottom bg-light">
        ...
        <div class="modal-dialog-search">
            <div class="modal-content-search">
                <div class="modal-body">
                    <h5 class="text-primary mb-3 mx-5">Search Affiliate Merchant</h5>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <ul class="menu-list">
                        ...
                        <li class="menu-item" @click="closeModal"><router-link
                                to="/tripidkard/details">Tripidkard</router-link></li>
                        ...
                        <li class="menu-item" @click="closeModal"><router-link to="/merchants">Merchants</router-link>
                        </li>
                        <li class="menu-item" @click="closeModal"><router-link to="/contact-us">Contact</router-link>
                        </li>

                        <!-- Conditional button for login or dashboard -->
                        <li class="menu-item" @click="closeModal">
                            <router-link :to="isLoggedIn ? '/login' : '/login'"
...
.mobile-footer {
    ...
    /* Center it */
    width: calc(100% - 20px);
    /* Ensure spacing from screen edges */
    ...
    /* Optional for a slight border effect */
}
