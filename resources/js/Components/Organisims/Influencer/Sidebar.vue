...
const menuItems = ref([
    {
        ...
        items: [
            ...
            },
            {
                ...
                icon: "fa fa-qrcode",
                route: "/influencer/scanner",
            },
            {
                title: "Order Card",
                icon: "fas fa-coins",
                children: [
                    { title: "Order Cards", icon: "far fa-circle", route: "/influencer/order/cards" },
                ],
            },
            {
                ...
                children: [
                    { title: "TripidKard List", icon: "far fa-circle", route: "/influencer/tripidkard" },
                ],
            },
            {
...
// Use `useRoute` to get access to the current route
