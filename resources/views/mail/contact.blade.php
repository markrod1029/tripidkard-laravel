                                            ...
                                            <tr>
                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                            ...
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;"
                                                                    ...
                                                                    <p class=""
                                                                        ...
                                                                        align="left">
                                                                        Thank you for reaching out to us. Below is your
                                                                        message:
                                                                    </p>
                                                                    <br>
                                                                    ...
                                                                    <p class=""
                                                                        ...
                                                                        align="left">
                                                                    <div
                                                                        style=" text-align:center; border: 1px solid #e2e8f0; border-radius: 4px; padding: 10px; background-color: #f9f9f9;">
                                                                        {{ $mailMessage }}
                                                                    </div>
                                                                    </p>
                                                                    ...
                                                                    <div class="text-muted text-center"
                                                                        style="color: #718096;" align="center">
                                                                        {{ $email }}<br>
                                                                    </div>
                                                    ...
                                                    <div class="text-muted text-center" style="color: #718096;"
                                                        align="center">
                                                        Best regards,<br><a
                                                            href="https://tripidkard.com">Tripidkard</a><br>
                                                    </div>
                                                    <table class="s-6 w-full" role="presentation" border="0"
                                                        cellpadding="0" cellspacing="0" style="width: 100%;"
                                                        width="100%">
